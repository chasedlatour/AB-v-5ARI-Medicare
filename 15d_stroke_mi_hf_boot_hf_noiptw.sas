/************************************************************************************************
	...
	PROGRAM: 15c_stroke_mi_hf_boot_hf_noiptw.sas
...
%setup(full, 15c_stroke_mi_hf_boot_hf_noiptw, saveLog=Y);
...
*%competingrisk_weights(inds=ana.cohort_str_mi_hf, startDT=FillDate2, eventDT=HF_date, crDT=death_dt, censorDT=endDT_itt, 
      daysEst=365, psvars=age cal_year bl_aur bl_tobacco bl_chdz /*bl_hf*/ bl_hf_hosp bl_chronickid bl_copd bl_hchl 
				...
				noiptw=0,
      numiterations=500, outds=ana.hf_365_st_hf_mi_boot);
