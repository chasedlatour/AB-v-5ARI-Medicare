/************************************************************************************************
	...
	PROGRAM: 9b_restr_exp_boot_hf_iptw.sas
	...
	This only considers those analyses with IPTW. This takes substantial time to run and so was
	batch submitted to the UNC server.
...
%setup(full, 9b_restr_exp_boot_hf_iptw, saveLog=Y);
...
%competingrisk_weights(inds=ana.p_cohort_restrict_exp, startDT=FillDate2, eventDT=HF_date, crDT=death_dt, censorDT=endDT_itt, 
      daysEst=365, psvars=age cal_year bl_aur bl_tobacco bl_chdz /*bl_hf*/ bl_hf_hosp bl_chronickid bl_copd bl_hchl 
				...
				noiptw=0,
      numiterations=500, outds=ana.hf_365_r_e_boot);
