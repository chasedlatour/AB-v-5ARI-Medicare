/************************************************************************************************
	...
	PROGRAM: 12c_bph_conf_comb_boot.sas
	DESCRIPTION:Combine the bootstrapped estimates from the analysis limited to patients with
	a BPH diagnosis code <= 6 months prior to new-use.
...
%calculate_est(inds=ana.hf_365_bph_c_boot, outds=hf_365_summary, fup=365, rd_multiple=1000);
data ana.hf_365_bph_c_summary; set ana.hf_365_summary; 
...
data ana.mace_365_bph_c_summary; set ana.mace_365_summary; 
...
proc sql;
	...
	select distinct *
	from ana.macehf_365_bph_c_boot
	; quit;
...
data ana.macehf_365_bph_c_summary; set ana.macehf_365_summary; 
...
data ana.death_365_bph_c_summary; set ana.death_365_summary; 
...
proc sql;
	create table bph_c_365_est_iptw as
	select * from ana.hf_365_bph_c_summary
	union
	select * from ana.mace_365_bph_c_summary
	union
	select * from ana.macehf_365_bph_c_summary
	union
	select * from ana.death_365_bph_c_summary
	;
	quit; 

data ana.bph_c_365_est_iptw (keep = risk0 risk0_CI risk1 risk1_CI
				rd rd_CI rr rr_ci rd_multiple variable);
set bph_c_365_est_iptw;
