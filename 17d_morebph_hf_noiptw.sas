/************************************************************************************************
	...
	PROGRAM: 15c_stroke_mi_hf_boot_hf_iptw.sas
	DESCRIPTION: This program conducts bootstrapping for HF as an outcome, only considering
	those analyses with IPTW (IPCW are still applied).
...
%setup(full, 17c_morebph_hf_noiptw, saveLog=Y);
...
*%competingrisk_weights(inds=ana.cohort_bph, startDT=FillDate2, eventDT=HF_date, crDT=death_dt, censorDT=endDT_itt, 
      daysEst=365, psvars=age cal_year bl_aur bl_tobacco bl_chdz /*bl_hf*/ bl_hf_hosp bl_chronickid bl_copd bl_hchl 
				...
				noiptw=0,
      numiterations=500, outds=ana.hf_365_bph2_boot);
...
%competingrisk_weights(inds=ana.cohort_bph, startDT=FillDate2, eventDT=HF_date, crDT=death_dt, censorDT=endDT_itt, 
      daysEst=365, psvars=age cal_year bl_aur bl_tobacco bl_chdz /*bl_hf*/ bl_hf_hosp bl_chronickid bl_copd bl_hchl 
				...
				noiptw=1,
      numiterations=500, outds=ana.hf_bph2_boot_noiptw);
