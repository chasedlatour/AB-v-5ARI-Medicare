/************************************************************************************************
	...
	DESCRIPTION: Bootstrap the primary study cohort and calculate RR and RD estimates
	in each of these cohorts. This code only considers those outcomes where the Kaplan-Meier
	estimator is appropriate. Specifically, this considers outcomes where mortality is one of
	the outcomes (i.e., MACE, MACE + HF, all-cause mortality).
...
%setup(full, 18a_ses_boot_risks, saveLog=Y);

proc contents data=ana.death_365_p_boot; run;
