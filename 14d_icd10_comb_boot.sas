/************************************************************************************************
	...
	PROGRAM: 14d_icd10_comb_boot.sas
	DESCRIPTION:Combine the bootstrapped estimates from theICD-10 sensitivity analysis.
...
TABLE OF CONTENTS:
	...
	00 - SET UP
	01 - FORMAT DATASET
	02 - COUNT THE NUMBER OF PEOPLE IN THE DATASET
...
%calculate_est(inds=ana.hf_365_icd10_boot, outds=hf_365_summary, fup=365, rd_multiple=1000);
data ana.hf_365_icd10_summary; set ana.hf_365_summary; 
...
data ana.mace_365_icd10_summary; set ana.mace_365_summary; 
...
proc sql;
	...
	select distinct *
	from ana.macehf_365_icd10_boot
	; quit;
...
data ana.macehf_365_icd10_summary; set ana.macehf_365_summary; 
...
data ana.death_365_icd10_summary; set ana.death_365_summary; 
...
proc sql;
	create table icd10_365_est_iptw as
	select * from ana.hf_365_icd10_summary
	union
	select * from ana.mace_365_icd10_summary
	union
	select * from ana.macehf_365_icd10_summary
	union
	select * from ana.death_365_icd10_summary
	;
	quit; 

data ana.icd10_365_est_iptw (keep = risk0 risk0_CI risk1 risk1_CI
				rd rd_CI rr rr_ci rd_multiple variable);
set icd10_365_est_iptw;
