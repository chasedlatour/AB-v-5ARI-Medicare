/************************************************************************************************
	...
	PROGRAM: 10a_ps_trim_boot_risks.sas
	DESCRIPTION: Bootstrap the RR and RD estimates for non-mortality outcomes (only with
...
%setup(full, 10a_ps_trim_boot_risks, saveLog=Y);
...
%risk_weights_multiple_pstrim(inds=ana.primary_cohort, startDT=FillDate2, censorDT=endDT_itt, 
