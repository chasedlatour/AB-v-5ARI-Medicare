/************************************************************************************************
	...
	PROGRAM: 3b_primary_boot_cabg_iptw.sas
	DESCRIPTION:This program conducts bootstrapping for CABG as an outcome, only considering
	those analyses with IPTW. These analyses take substantial time to run and so were batch
...
Needs to have different values based on the outcome assessed
	...
	(2) composite MACE (hosp for stroke, MI, or death from any cause) - NOT HERE
	(3) composite MACE or hosp for HF - NOT HERE
	(4) death from any cause - NOT HERE
	(5) PCIP - NOT HERE
	(6) CABG
