...
%macro competingrisk_weights_pstrim(inds=cohort, startDT=indexDate, eventDT=outcomeDT, crDT=deathDT, censorDT=censorDT, 
...
*STEP 1: PREPARE ANALYTIC COHORT DATASET;
   ...
   *1b: Jitter tied event times;
	...
	*STEP 2: CREATE BOOTSTRAP SAMPLES;
      ...
      *STEP 3c: RE-FIT PS MODEL & CREATE IPT WEIGHTS;
	  ...
	  %PUT Calculate summary statitics (RD, RR);
