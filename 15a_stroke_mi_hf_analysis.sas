/************************************************************************************************
	...
	to those patients who had at least 1 in-patient hospitalization for MI, HF, or stroke 
	within 12 months prior to cohort entry.
...
%setup(full, 15a_stroke_mi_hf_analysis, saveLog=N);
...
data ana.cohort_str_mi_hf;
set ana.primary_cohort;
	
	where bl_strk = 1 or bl_mi = 1 or bl_hf_hosp = 1;

run;

*Dropped from 189,886 persons to 12,496 persons/new-use episodes;
...
%ps(inds = ana.cohort_str_mi_hf, outds = ps);
...
ods rtf file="&OutPath./Table 1: Distribution of Study Baseline Characteristics_Trimmed_Stroke HF MI Population_&logdate..rtf" style=vpmin startpage=never ;
...
ods noptitle; ods escapechar='~';Title ;
ods rtf file="&OutPath./Table 1: Distribution of Study Baseline Characteristics with IPTW_Trimmed_Stroke HF MI Population_&logdate..rtf" style=vpmin startpage=never ;
