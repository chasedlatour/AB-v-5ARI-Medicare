/************************************************************************************************
	...
	PROGRAM: 12a_bph_conf_boot_risks.sas
	DESCRIPTION: Re-run the primary analyses controlling for additional indicators of BPH severity.

	This code only considers non-mortality outcomes since they are less-computationally intensive to
	run. We only ran analyses with IPTW.
...
%setup(full, 12a_bph_conf_boot_risks, saveLog=Y);
