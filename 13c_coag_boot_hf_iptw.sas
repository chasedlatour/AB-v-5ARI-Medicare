/************************************************************************************************
	...
	PROGRAM: 13c_coag_boot_hf_iptw.sas
	DESCRIPTION: Bootstrap the RR and RD estimates among new-use episodes that don't have a
	history of anticoagulant use. Only IPTW estimates considered.
...
%setup(full, 13c_coag_boot_hf_iptw, saveLog=Y);
...
%competingrisk_weights(inds=ana.p_cohort_restrict_coag, startDT=FillDate2, eventDT=HF_date, crDT=death_dt, censorDT=endDT_itt, 
      daysEst=365, psvars=age cal_year bl_aur bl_tobacco bl_chdz /*bl_hf*/ bl_hf_hosp bl_chronickid bl_copd bl_hchl 
				...
				noiptw=0,
      numiterations=500, outds=ana.hf_365_coag_boot);
