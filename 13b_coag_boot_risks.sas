/************************************************************************************************
	...
	PROGRAM: 13b_coag_boot_risks.sas
	DESCRIPTION: Bootstrap the RR and RD estimates for non-mortality outcomes (only with
	IPTW). This analysis is conducted among new-use episodes withoutu a prior history of
	anticoagulant use.
...
%setup(full, 13b_coag_boot_risks, saveLog=Y);
...
%risk_weights_multiple(inds=ana.p_cohort_restrict_coag, startDT=FillDate2, censorDT=endDT_itt, 
