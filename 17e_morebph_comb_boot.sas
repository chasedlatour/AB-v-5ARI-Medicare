...
%setup(full, 17e_morebph_comb_boot, saveLog=N);
...
/*proc contents data=ana.hf_365_bph2_boot; */
/*run;*/
*500 - it's done running;

*Calculate the study estimates;
%calculate_est(inds=ana.hf_365_bph2_boot, outds=hf_365_bph2_summary, fup=365, rd_multiple=1000);
data ana.hf_365_bph2_summary; set ana.hf_365_bph2_summary; 
...
*Figure out the number of rows;
/*proc contents data=ana.mace_365_bph2_boot; */
/*run;*/
*500 - it's done running;
...
*De-dup the dataset;
proc sql;
	create table mace_365_bph2 as
	select distinct *
	from ana.mace_365_bph2_boot
	; quit;


*Rename the variables;
%rename_risk(inds=mace_365_bph2, fup=365);

*Calculate the study estimates;
%calculate_est(inds=rename_mace_365_bph2, outds=mace_365_bph2_summary, fup=365, rd_multiple=1000);
data ana.mace_365_bph2_summary; set ana.mace_365_bph2_summary; 
...
*De-dup the dataset;
proc sql;
	create table macehf_365_bph2 as
	select distinct *
	from ana.macehf_365_bph2_boot
	; quit;

*Rename the variables;
%rename_risk(inds=macehf_365_bph2, fup=365);

*Calculate the study estimates;
%calculate_est(inds=rename_macehf_365_bph2, outds=macehf_365_bph2_summary, fup=365, rd_multiple=1000);
data ana.macehf_365_bph2_summary; set ana.macehf_365_bph2_summary; 
...
*De-dup the dataset;
proc sql;
	create table death_365_bph2 as
	select distinct *
	from ana.death_365_bph2_boot
	; quit;

*Rename the variables;
%rename_risk(inds=death_365_bph2, fup=365);

*Calculate the study estimates;
%calculate_est(inds=rename_death_365_bph2, outds=death_365_bph2_summary, fup=365, rd_multiple=1000);
data ana.death_365_bph2_summary; set ana.death_365_bph2_summary; 
...
proc sql;
	create table bph2_365_est_iptw as
	select * from ana.hf_365_bph2_summary
	union
	select * from ana.mace_365_bph2_summary
	union
	select * from ana.macehf_365_bph2_summary
	union
	select * from ana.death_365_bph2_summary
	;
	quit; 

data ana.bph2_365_est_iptw (keep = risk0 risk0_CI risk1 risk1_CI
				rd rd_CI rr rr_ci rd_multiple variable);
set bph2_365_est_iptw;
