...
%setup(full, 18c_ses_comb_boot, saveLog=N);
...
/*proc contents data=ana.hf_365_ses_boot; */
/*run;*/
*All 500 are here;


*Calculate the study estimates;
%calculate_est(inds=ana.hf_365_ses_boot, outds=hf_365_ses_summary, fup=365, rd_multiple=1000);
data ana.hf_365_ses_summary; set ana.hf_365_ses_summary; 
...
*Figure out the number of rows;
/*proc contents data=ana.mace_365_ses_boot; */
/*run;*/
...
*De-dup the dataset;
proc sql;
	create table mace_365_ses as
	select distinct *
	from ana.mace_365_ses_boot
	; quit;


*Rename the variables;
%rename_risk(inds=mace_365_ses, fup=365);

*Calculate the study estimates;
%calculate_est(inds=rename_mace_365_ses, outds=mace_365_ses_summary, fup=365, rd_multiple=1000);
data ana.mace_365_ses_summary; set ana.mace_365_ses_summary; 
...
*De-dup the dataset;
proc sql;
	create table macehf_365_ses as
	select distinct *
	from ana.macehf_365_ses_boot
	; quit;

*Rename the variables;
%rename_risk(inds=macehf_365_ses, fup=365);

*Calculate the study estimates;
%calculate_est(inds=rename_macehf_365_ses, outds=macehf_365_ses_summary, fup=365, rd_multiple=1000);
data ana.macehf_365_ses_summary; set ana.macehf_365_ses_summary; 
...
*De-dup the dataset;
proc sql;
	create table death_365_ses as
	select distinct *
	from ana.death_365_ses_boot
	; quit;

*Rename the variables;
%rename_risk(inds=death_365_ses, fup=365);

*Calculate the study estimates;
%calculate_est(inds=rename_death_365_ses, outds=death_365_ses_summary, fup=365, rd_multiple=1000);
data ana.death_365_ses_summary; set ana.death_365_ses_summary; 
...
proc sql;
	create table ses_365_est_iptw as
	select * from ana.hf_365_ses_summary
	union
	select * from ana.mace_365_ses_summary
	union
	select * from ana.macehf_365_ses_summary
	union
	select * from ana.death_365_ses_summary
	;
	quit; 

data ana.ses_365_est_iptw (keep = risk0 risk0_CI risk1 risk1_CI
				rd rd_CI rr rr_ci rd_multiple variable);
set ses_365_est_iptw;
