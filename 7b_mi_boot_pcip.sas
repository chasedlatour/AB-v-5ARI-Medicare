...
%setup(full, 7b_mi_boot_pcip, saveLog=Y);
...
%competingrisk_weights(inds=ana.mi_cohort, startDT=FillDate2, eventDT=pcip_cpt_carr_date, crDT=death_dt, censorDT=endDT_itt, 
      daysEst=365, psvars=age cal_year bl_aur bl_tobacco 
				...
				noiptw=0,
      numiterations=500, outds=ana.pcip_365_mi_boot);
...
%competingrisk_weights(inds=ana.mi_cohort, startDT=FillDate2, eventDT=pcip_cpt_carr_date, crDT=death_dt, censorDT=endDT_itt, 
      daysEst=365, psvars=age cal_year bl_aur bl_tobacco 
				...
				bl_outpatientvisit bl_rehab bl_oxygen bl_wheelchair, trtvar=ab, 
				noiptw=1,
      numiterations=500, outds=ana.pcip_365_mi_boot_noiptw);
