/************************************************************************************************
	...
	PROGRAM: 19a_boot_injury_iptw.sas
	DESCRIPTION: This program conducts bootstrapping for hospitalization for injury or poisoning
	as an outcome, only considering those analyses with IPTW. 
...
%setup(full, 19a_boot_injury_iptw, saveLog=Y);
...
**
(1) hosp for injury or poisoning
**;
...
%competingrisk_weights(inds=ana.primary_cohort, startDT=FillDate2, eventDT=injury_date, crDT=death_dt, censorDT=endDT_itt, 
      daysEst=365, psvars=age cal_year bl_aur bl_tobacco bl_chdz /*bl_hf*/ bl_hf_hosp bl_chronickid bl_copd bl_hchl 
				...
				noiptw=0,
      numiterations=500, outds=ana.injury_365_boot);
