/************************************************************************************************
	...
	DESCRIPTION: Bootstrap effect estimates from KM curves for the analysis relegated to
...
%setup(full, 7a_mi_boot_risks, saveLog=Y);
...
%risk_weights_multiple(inds=ana.mi_cohort, startDT=FillDate2, censorDT=endDT_itt, 
